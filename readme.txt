...
<strong>THE COMPANION WORDPRESS PLUGIN FOR USING STATUS MACHINE</strong><br />
...
= 2.4.0 =
* Always send the WordPress core version with all the calls
* Sends plugin's Version when (dea)activating or upgrading it
* If it's a Post, we also send the post_type, to be more precise
